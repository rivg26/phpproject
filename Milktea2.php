                ...
                <div class="px-lg-5">
                  ...
                  <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                      <div class="bg-white rounded shadow-sm"><img src="pictures/1.png" alt="" class="img-fluid card-img-top" id="coffeepic1">
                        <div class="p-4">
                          ...
                          <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4">
                            <label class="checkbox mx-2 "><input type="checkbox" class="coffeeclass" id="coffee1"><span class="checkbox-check mx-2"></span>Add to Cart</label>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <!-- Gallery item -->
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                      <div class="bg-white rounded shadow-sm"><img src="pictures/2.png" alt="" class="img-fluid card-img-top">
                        <div class="p-4">
                          ...
                          <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4">
                            <label class="checkbox mx-2"><input type="checkbox" class="coffeeclass" id="coffee2"><span class="checkbox-check mx-2"></span>Add to Cart</label>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <!-- Gallery item -->
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                      <div class="bg-white rounded shadow-sm"><img src="pictures/3.png" alt="" class="img-fluid card-img-top">
                        <div class="p-4">
                          ...
                          <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4">
                            <label class="checkbox mx-2"><input type="checkbox" class="coffeeclass" id="coffee3"><span class="checkbox-check mx-2"></span>Add to Cart</label>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <!-- Gallery item -->
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                      <div class="bg-white rounded shadow-sm"><img src="pictures/4.png" alt="" class="img-fluid card-img-top">
                        <div class="p-4">
                          ...
                          <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4">
                            <label class="checkbox mx-2"><input type="checkbox" class="coffeeclass" id="coffee4"><span class="checkbox-check mx-2"></span>Add to Cart</label>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <!-- Gallery item -->
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                      <div class="bg-white rounded shadow-sm"><img src="pictures/5.png" alt="" class="img-fluid card-img-top">
                        <div class="p-4">
                          ...
                          <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4">
                            <label class="checkbox mx-2"><input type="checkbox" class="coffeeclass" id="coffee5"><span class="checkbox-check mx-2"></span>Add to Cart</label>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <!-- Gallery item -->
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                      <div class="bg-white rounded shadow-sm"><img src="pictures/6.png" alt="" class="img-fluid card-img-top">
                        <div class="p-4">
                          ...
                          <p class="small text-muted mb-0">Double shot of espresso is basically Doppio with the use of
                            ...
                            coffee.<br><br><br></p>
                          <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4">
                            <label class="checkbox mx-2"><input type="checkbox" class="coffeeclass" id="coffee6"><span class="checkbox-check mx-2"></span>Add to Cart</label>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <!-- Gallery item -->
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                      <div class="bg-white rounded shadow-sm"><img src="pictures/7.png" alt="" class="img-fluid card-img-top">
                        <div class="p-4">
                          ...
                          <p class="small text-muted mb-0">The clear form of espresso is called Ristretto. The boldest
                            ...
                            beans.<br><br></p>
                          <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4">
                            <label class="checkbox mx-2"><input type="checkbox" class="coffeeclass" id="coffee7"><span class="checkbox-check mx-2"></span>Add to Cart</label>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <!-- Gallery item -->
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                      <div class="bg-white rounded shadow-sm"><img src="pictures/8.png" alt="" class="img-fluid card-img-top">
                        <div class="p-4">
                          ...
                          <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4">
                            <label class="checkbox mx-2"><input type="checkbox" class="coffeeclass" id="coffee8"><span class="checkbox-check mx-2"></span>Add to Cart</label>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <!-- Gallery item -->
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                      <div class="bg-white rounded shadow-sm"><img src="pictures/9.png" alt="" class="img-fluid card-img-top">
                        <div class="p-4">
                          ...
                          <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4">
                            <label class="checkbox mx-2"><input type="checkbox" class="coffeeclass" id="coffee9"><span class="checkbox-check mx-2"></span>Add to Cart</label>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <!-- Gallery item -->
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                      <div class="bg-white rounded shadow-sm"><img src="pictures/10.png" alt="" class="img-fluid card-img-top">
                        <div class="p-4">
                          ...
                          <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4">
                            <label class="checkbox mx-2"><input type="checkbox" class="coffeeclass" id="coffee10"><span class="checkbox-check mx-2"></span>Add to Cart</label>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <!-- Gallery item -->
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                      <div class="bg-white rounded shadow-sm"><img src="pictures/11.png" alt="" class="img-fluid card-img-top">
                        <div class="p-4">
                          ...
                          <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4">
                            <label class="checkbox mx-2"><input type="checkbox" class="coffeeclass" id="coffee11"><span class="checkbox-check mx-2"></span>Add to Cart</label>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <!-- Gallery item -->
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                      <div class="bg-white rounded shadow-sm"><img src="pictures/12.png" alt="" class="img-fluid card-img-top">
                        <div class="p-4">
                          ...
                          <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4">
                            <label class="checkbox mx-2"><input type="checkbox" class="coffeeclass" id="coffee12"><span class="checkbox-check mx-2"></span>Add to Cart</label>
                          </div>
                        </div>
                      </div>
                      <!-- End -->
              ...
              <div class="container-fluid">
                <div class="px-lg-5">
                  ...
                  <div class="row">
                    <!-- Gallery item -->
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                      <div class="bg-white rounded shadow-sm"><img src="pictures/13.png" alt="" class="img-fluid card-img-top">
                        <div class="p-4">
                          ...
                          <p class="small text-muted mb-0">Everything has to be tried with different things to give it a
                            ...
                            side<br><br><br><br></p>
                          <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4">
                            <label class="checkbox mx-2"><input type="checkbox" class="coffeeclass" id="coffee13"><span class="checkbox-check mx-2"></span>Add to Cart</label>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <!-- Gallery item -->
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                      <div class="bg-white rounded shadow-sm"><img src="pictures/14.png" alt="" class="img-fluid card-img-top">
                        <div class="p-4">
                          ...
                          <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4">
                            <label class="checkbox mx-2"><input type="checkbox" class="coffeeclass" id="coffee14"><span class="checkbox-check mx-2"></span>Add to Cart</label>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <!-- Gallery item -->
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                      <div class="bg-white rounded shadow-sm"><img src="pictures/15.png" alt="" class="img-fluid card-img-top">
                        <div class="p-4">
                          ...
                          <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4">
                            <label class="checkbox mx-2"><input type="checkbox" class="coffeeclass" id="coffee15"><span class="checkbox-check mx-2"></span>Add to Cart</label>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <!-- Gallery item -->
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                      <div class="bg-white rounded shadow-sm"><img src="pictures/16.png" alt="" class="img-fluid card-img-top">
                        <div class="p-4">
                          ...
                          <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4">
                            <label class="checkbox mx-2"><input type="checkbox" class="coffeeclass" id="coffee16"><span class="checkbox-check mx-2"></span>Add to Cart</label>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <!-- Gallery item -->
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                      <div class="bg-white rounded shadow-sm"><img src="pictures/17.png" alt="" class="img-fluid card-img-top">
                        <div class="p-4">
                          ...
                          <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4">
                            <label class="checkbox mx-2"><input type="checkbox" class="coffeeclass" id="coffee17"><span class="checkbox-check mx-2"></span>Add to Cart</label>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <!-- Gallery item -->
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                      <div class="bg-white rounded shadow-sm"><img src="pictures/18.png" alt="" class="img-fluid card-img-top">
                        <div class="p-4">
                          ...
                          <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4">
                            <label class="checkbox mx-2"><input type="checkbox" class="coffeeclass" id="coffee18"><span class="checkbox-check mx-2"></span>Add to cart</label>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <!-- Gallery item -->
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                      <div class="bg-white rounded shadow-sm"><img src="pictures/19.png" alt="" class="img-fluid card-img-top">
                        <div class="p-4">
                          ...
                          <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4">
                            <label class="checkbox mx-2"><input type="checkbox" class="coffeeclass" id="coffee19"><span class="checkbox-check mx-2"></span>Add to Cart</label>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <!-- Gallery item -->
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                      <div class="bg-white rounded shadow-sm"><img src="pictures/20.png" alt="" class="img-fluid card-img-top">
                        <div class="p-4">
                          ...
                          <p class="small text-muted mb-0"> Doppio is taken and poured above orange peel also lemon peel
                            ...
                            savor of espresso. </p>
                          <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4">
                            <label class="checkbox mx-2"><input type="checkbox" class="coffeeclass" id="coffee20"><span class="checkbox-check mx-2"></span>Add to Cart</label>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="col-md-12 mb-2">
                  <div class="col-md-12">
                    <div class="input-group input-group-sm mb-1">
                      ...
                      <input type="text" class="form-control" id="price" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" readonly>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-12">
                  <div class="col-md-12">
                    <div class="input-group input-group-sm mb-1 ">
                      ...
                      <input type="text" class="form-control" aria-label="Sizing example input" id="quantity" aria-describedby="inputGroup-sizing-sm">
                    </div>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                  <div class="input-group input-group-sm mb-1">
                    ...
                    <input type="text" class="form-control" aria-label="Sizing example input" id="discountamount" aria-describedby="inputGroup-sizing-sm" readonly>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                  <div class="input-group input-group-sm mb-1">
                    ...
                    <input type="text" class="form-control" aria-label="Sizing example input" id="discountedamount" aria-describedby="inputGroup-sizing-sm" readonly>
                  </div>
                </div>
              </div>
              <div class="row ">
                <div class="col-md-12 ">
                  <div class="input-group input-group-sm mb-1 ">
                    ...
                    <input type="text" class="form-control" aria-label="Sizing example input" id="totalbills" aria-describedby="inputGroup-sizing-sm" readonly>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                  <div class="input-group input-group-sm mb-1">
                    ...
                    <input type="text" class="form-control" aria-label="Sizing example input" id="totalquantity" aria-describedby="inputGroup-sizing-sm" readonly>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                  <div class="input-group input-group-sm mb-1">
                    ...
                    <input type="text" class="form-control" aria-label="Sizing example input" id="cashgiven" aria-describedby="inputGroup-sizing-sm">
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                  <div class="input-group input-group-sm mb-1">
                    ...
                    <input type="text" class="form-control " aria-label="Sizing example input" id="change" aria-describedby="inputGroup-sizing-sm" readonly>
                  </div>
                </div>
              </div>
