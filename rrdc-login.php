				...
				<div class="myform form ">
                   ...
                   <form id = "form">
                           ...
                           <div class="form-group">
                              <a href="rrdc-forgot.php" id="signup" class = "px-2">Forgot Password?</a>
                           </div>
                           <div class="form-group mt-4 ">
                              <p class="text-center ">By logging in you accept our <a href="terms.php">Terms Of Use</a></p>
                           </div>
                           ...
                           <div class="form-group mt-4">
                              <p class="text-center">No Account Yet? <a href="rrdc-signup.php" id="signup">Sign Up here!</a></p>
                           </div>
...
<script type = "text/javascript" src = "js/rrdc-login.js"></script>
 </html>